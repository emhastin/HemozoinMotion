...
for j, tamsd_system in enumerate(tamsd_systems):
	...
	p, _ = perform_weighted_fit(norm_diff_stat_loc_err, times, tamsd, dtamsd, 36, 146)
...
# axb.plot(times[:zoom_range], 4*0.18*times[:zoom_range]**0.72+0.026, '--')
# axb.plot(times[:zoom_range], 4*1.0*times[:zoom_range]**0.72+0.026, '--')
